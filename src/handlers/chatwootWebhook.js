...
async function handleChatwootToMaxMessage(webhookPayload) {
    ...
    try {
        // Send text message
        if (content) {
            await bot.api.sendMessage(maxUserId, content);
...
//# sourceMappingURL=chatwootWebhook.js.map